                ...
                {rule && (
                    <>
                        ...
                        <div className="rule-drawer__header">
                            ...
                            <button className="rule-drawer__close" onClick={onClose} aria-label="Kapat">
                        ...
                        <div className="rule-drawer__meta">
                            {rule.severity && (
                                <div className="rule-drawer__meta-item">
                                    <span className="rule-drawer__meta-label">Önem</span>
                            ...
                            {rule.category && (
                                <div className="rule-drawer__meta-item">
                                    <span className="rule-drawer__meta-label">Kategori</span>
                                    <span className="rule-drawer__meta-value">{rule.category}</span>
                                </div>
                            )}
                            {rule.subcategory && (
                                <div className="rule-drawer__meta-item">
                                    <span className="rule-drawer__meta-label">Alt Kategori</span>
                                    <span className="rule-drawer__meta-value">{rule.subcategory}</span>
                                </div>
                            )}
                            <div className="rule-drawer__meta-item">
                                <span className="rule-drawer__meta-label">Bölüm</span>
                        ...
                        <div className="rule-drawer__section">
                            <h3 className="rule-drawer__section-title">Kısa Açıklama</h3>
                            <p className="rule-drawer__placeholder">
                                Bu kural için açıklama henüz eklenmedi.
                            </p>
                        </div>
